    ...
    <div class="cbx-backend_container_header">
        <div class="cbx-backend_wrapper cbx-backend_header_wrapper">
            <div class="menu-heading">
                <img title="CBX WP Bookmark - Dashboard" src="<?php echo CBXWPBOOKMARK_ROOT_URL .'assets/img/icon_log.svg'
                                        ...
                                        <div class="feature-card-body static">
                                            <div class="feature-card-header">
                                                <a href="https://codeboxr.com/product/cbx-wordpress-bookmark/?utm_source=plgsidebarinfo&utm_medium=plgsidebar&utm_campaign=wpfreemium"
                                                   target="_blank"> <img src="https://codeboxr.com/wp-content/uploads/productshots/445-profile.png"
                                    ...
                                    <div class="cbx-backend-feature-card">
                                        <div class="feature-card-body static">
                                            ...
                                            <div class="feature-card-description">
                                                ...
                                                <p>This plugin integrates CBX Bookmark plugin with myCred plugin. Users gets point by bookmarking a
                                                    post</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="cbx-backend-settings-row">
                                <p>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                                        <defs/>
                                        <path d="M9.4 11.9c-2 0-3.5-1.6-3.5-3.5V5.9c0-.2.2-.4.4-.4s.4.2.4.4v2.5c0 1.5 1.3 2.8 2.8 2.8s2.8-1.3 2.8-2.8v-.7c0-.2.2-.4.4-.4s.4.2.4.4v.6c-.1 2-1.7 3.6-3.7 3.6z" fill="currentColor"/>
                                        ...
                                        <div class="cbx-backend-settings-row">
                                            <a href="<?php echo $url ?>" target="_blank">
                                                <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                    <defs/>
                                                    <path d="M16.4 9.1L12.2 5c-.3-.3-.7-.3-1-.2s-.6.5-.6.9v1.7H4.2c-.5 0-.9.4-.9.9v3.4c0 .2.1.5.3.7.2.2.4.3.7.3h6.4v1.7c0 .4.2.7.6.9.4.1.8.1 1-.2l4.1-4.2c.4-.5.4-1.3 0-1.8z" fill="currentColor"/>
                                                </svg>
                ...
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                    ...
                    <div class="cbx-backend-card dashboard-support">
                        ...
                        <div class="content">
                            ...
                            <div class="cbx-backend-settings-row">
                                <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20Bookmark" target="_blank">
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        ...
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[improvement]</strong> My bookmark (Default list and Grid(pro addon)) and category shortcode now takes username and email as userid</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[improvement]</strong> Dashboard Improvement</li>
                                    <li><strong>[new]</strong> Category privacy default status(if user mode enabled)</li>
                                    <li><strong>[new]</strong> Hide category privacy field</li>
                                </ul>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <p>
                                ...
                                <ul>
                                    <li><strong>[improvement]</strong> Compatibility release with pro addon.</li>
                                </ul>
                            </div>
                        </div>
                    </div><!--End Changelog-->
