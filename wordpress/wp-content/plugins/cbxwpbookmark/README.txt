...
* [new] Add new helper function getTotalBookmarkByCategoryByUser($cat_id = 0, $user_id = 0) that helps to get bookmark count by cat id and user id
* [new] Add new helper function getTotalBookmarkByUserByPostype($user_id = 0, $post_type = '') that helps to get bookmark count by user id and post id
* [new] Add new helper function getTotalBookmarkByUser($user_id = 0) that helps to get bookmark count by user id

= 1.6.6 =

* [improvement] My bookmark (Default list and Grid(pro addon)) and category shortcode now takes username and email as userid

= 1.6.5 =

* [improvement] Dashboard Improvement
* [new] Category privacy default status(if user mode enabled)
* [new] Hide category privacy field
